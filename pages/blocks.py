...
class StatisticsBlock(blocks.StructBlock):
    ...
    text = blocks.TextBlock(required=False)
    button = SimpleButton(required=False)
    ...
    class Meta:
        label = "Statistics"
        template = "pages/blocks/statistics_block.html"
...
class TestimonialsBlock(blocks.StructBlock):
    ...
    class Meta:
        label = "Testimonials"
        template = "pages/blocks/testimonials_block.html"

class CoCurricularSliderBlock(blocks.StructBlock):
    top_padding = blocks.ChoiceBlock(top_padding_list,required=False)
    bottom_padding = blocks.ChoiceBlock(bottom_padding_list,required=False)
    label = blocks.CharBlock(required=False, help_text="Small label text (e.g., 'CO-CURRICULAR')")
